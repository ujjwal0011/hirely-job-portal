      ...
      <CardContent className="p-8 space-y-8">
          ...
          <>
            ...
            <div className="space-y-6">
              ...
              {[
                {
                  value: firstNiche,
                  setter: setFirstNiche,
                  label: "Primary Niche",
                },
                {
                  value: secondNiche,
                  setter: setSecondNiche,
                  label: "Secondary Niche",
                },
                {
                  value: thirdNiche,
                  setter: setThirdNiche,
            ...
            <div className="space-y-4">
              <Label
                htmlFor="coverLetter"
                className="text-2xl font-semibold flex items-center text-gray-800"
              >
        ...
        <div className="pt-6">
          <Button
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 rounded-xl text-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-200"
          >
